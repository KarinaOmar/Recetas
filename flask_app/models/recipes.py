...
class Recipe:
    ...
    def save(cls, formulario):
        #formulario {name: ...., description:.....instructions:..., date_made: 00/00/000, under30 - 0 o 1 y user id}
    ...
    def delete(cls, formulario):
        #formulario = {id:1} solo identificador de la receta q se quiere borrar
